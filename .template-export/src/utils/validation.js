      ...
      page.id === homePage.id
        ? {
          ...
          blocks: parentId
            ...
            : insertBlockAt(page.blocks, block, targetIndex),
        }
        : page
    )),
  });
    ...
    pages: data.pages.map((page) => {
      ...
      return {
        ...
        blocks: targetParentId
          ...
          : insertBlockAt(extraction.blocks, extraction.block, targetIndex),
      };
    }),
  });
}
...
function addBlockToParent(blocks, parentId, blockToAdd, targetIndex = null) {
  return blocks.map((block) => {
    if (block.id === parentId) {
      return {
        ...block,
        children: insertBlockAt(block.children || [], blockToAdd, targetIndex),
      };
    }
